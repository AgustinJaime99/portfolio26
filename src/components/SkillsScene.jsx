...
const SKILLS = [
  ...
  { name: 'Kafka',        color: '#b5e0f5', desc: { es: 'Mensajería de eventos distribuida.', en: 'Distributed event streaming.' }, usage: { es: 'Implementé comunicación asíncrona entre microservicios con Kafka. Lo uso para desacoplar servicios, manejar picos de carga y garantizar entrega de eventos de forma confiable.', en: 'Implemented async communication between microservices with Kafka. I use it to decouple services, handle load spikes and guarantee reliable event delivery.' } },
]
